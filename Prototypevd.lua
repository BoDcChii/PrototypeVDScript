-- [[ BoDcChii Project - v5.0.5: ULTRA-STABLE EXECUTION 🎸 ]] --
...
Sidebar.Size = UDim2.new(0, 110, 1, -45); Sidebar.Position = UDim2.new(1, -115, 0, 42); Sidebar.BackgroundTransparency = 1
Instance.new("UIListLayout", Sidebar).Padding = UDim.new(0, 5)

local ContentArea = Instance.new("Frame", MainFrame)
ContentArea.Size = UDim2.new(1, -140, 1, -50); ContentArea.Position = UDim2.new(0, 10, 0, 45); ContentArea.BackgroundTransparency = 1

local function CreateTabBtn(text)
    local btn = Instance.new("TextButton", Sidebar); btn.Size = UDim2.new(1, 0, 0, 35); btn.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
    btn.Text = text; btn.TextColor3 = Color3.new(1, 1, 1); btn.Font = Enum.Font.SourceSansBold; btn.TextSize = 11
